...
const Navbar = () => {
  ...
  const handleMenuToggle = () => setIsMenuOpen(!isMenuOpen);  // Add this line

  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <Link href="/" className="flex items-center">
          <svg className="pr-2 w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 19 19">
          ...
          <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">MDWiki</span>
        </Link>
        <button 
        ...
        <div 
          className={`${isMenuOpen ? 'block' : 'hidden'} w-full md:block md:w-auto`}  // Update this line
          id="navbar-default"
        >
